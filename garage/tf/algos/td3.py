...
method to optimize the policy and reward prediction.
"""
...
class TD3(OffPolicyRLAlgorithm):
    ...
    def optimize_policy(self, itr, samples_data):
        ...
        target_q1vals = self.target_qf_f_prob_online(next_inputs,
                                                     target_actions)
        target_q2vals = self.target_qf2_f_prob_online(next_inputs,
                                                      target_actions)
        target_qvals = min(target_q1vals, target_q2vals)
        ...
        qval_loss = min(qval_loss, q2val_loss)
        q2val = min(qval, q2val)
